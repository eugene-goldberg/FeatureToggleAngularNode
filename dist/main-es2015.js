...
let AppComponent = class AppComponent {
    ...
    // }
    addNew(issue) {
        const dialogRef = this.dialog.open(_dialogs_add_add_dialog_component__WEBPACK_IMPORTED_MODULE_8__["AddDialogComponent"], {
            data: { issue: issue }
        });
    ...
    startEdit(i, id, application, component, feature, isOn) {
        this.id = id;
        // index row is used just for debugging proposes and can be removed
        this.index = i;
        console.log(this.index);
        const dialogRef = this.dialog.open(_dialogs_edit_edit_dialog_component__WEBPACK_IMPORTED_MODULE_9__["EditDialogComponent"], {
    ...
    deleteItem(i, id, application, component, feature, isOn) {
        this.index = i;
        this.id = id;
...
class ExampleDataSource extends _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_7__["DataSource"] {
    constructor(_exampleDatabase, _paginator, _sort) {
        ...
        this._sort = _sort;
        this._filterChange = new rxjs__WEBPACK_IMPORTED_MODULE_11__["BehaviorSubject"]('');
        this.filteredData = [];
        this.renderedData = [];
