...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.startEdit = function (i, id, application, component, feature, on) {
        var _this = this;
        this.id = id;
    ...
    AppComponent.prototype.deleteItem = function (i, id, application, component, feature, on) {
        var _this = this;
        this.index = i;
        this.id = id;
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.addIssue = function (issue) {
        ...
        var feature = this.dialogData['feature'];
        var on = this.dialogData['on'];
        var dataObject = { requestIond: requestId, application: application, component: component,
            feature: feature, on: on };
    ...
    DataService.prototype.updateIssue = function (issue) {
        ...
        var feature = this.dialogData['feature'];
        var on = this.dialogData['on'];
        var dataObject = { id: id, application: application, component: component, feature: feature, on: on };
...
var environment = {
    production: false,
    ApiUrl: "https://mds-dev-flagger-funcs.azurewebsites.net/api"
};
...
module.exports = __webpack_require__(/*! /Users/s898840/projects/FeatureToggleAngularNode/src/main.ts */"./src/main.ts");
